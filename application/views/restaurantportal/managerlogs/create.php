...
<div class="title_bar flexable">
    <form class="row  align-items-center" id="data_picker">
        <div class="col-12 col-sm-12 div_inline">
                            ...
                            <div class="row ">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row flex_row">
                                        <div class="col-sm-3 col-xl-3 col-md-4 "> <label>Code</label></div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row flex_row">
                                        <div class="col-sm-3 col-xl-3 col-md-4"> <label>Amount</label></div>
                                        <div class="col-sm-9 col-xl-9 col-md-8">
                                            <p class="span_width">₦</p><input type="text"
                                                pattern="[\-\+]?[0-9]*(\.[0-9]+)?" class="form-control input_width"
                                                name="deposit_drop_amount" id="deposit_drop_amount" value="0" />
                                            <p class="span_width"></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="collapsetwo" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            <div class="row ">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row flex_row">
                                        ...
                                        <div class="col-sm-9 col-xl-9 col-md-8">
                                            <p class="span_width">₦</p><input type="text"
                                                pattern="[\-\+]?[0-9]*(\.[0-9]+)?" class="form-control input_width"
                                                name="petty_cash_amount" id="petty_cash_amount" value="0" />
                                            <p class="span_width"></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row flex_row">
                                        <div class="col-sm-3 col-xl-3 col-md-4"> <label>Description</label></div>
                                        <div class="col-sm-9 col-xl-9 col-md-8">
                                            <p class="span_width"></p><input type="text"
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row flex_row">
                                        ...
                                        <div class="col-sm-9 col-xl-9 col-md-8">
                                            <p class="span_width">₦</p><input type="text"
                                                pattern="[\-\+]?[0-9]*(\.[0-9]+)?" class="form-control input_width"
                                                name="breakfast_sales" id="breakfast_sales" value="0" />
                                            <p class="span_width"></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row flex_row">
                                        ...
                                        <div class="col-sm-9 col-xl-9 col-md-8">
                                            <p class="span_width"></p><input type="text" pattern="[0-9]*"
                                                class="form-control input_width" name="breakfast_guest_count"
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row flex_row">
                                        ...
                                        <div class="col-sm-9 col-xl-9 col-md-8">
                                            <p class="span_width">₦</p><input type="text"
                                                pattern="[\-\+]?[0-9]*(\.[0-9]+)?" class="form-control input_width"
                                                name="lunch_sales" id="lunch_sales" value="0" />
                                            <p class="span_width"></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="collapsethree" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row flex_row">
                                        ...
                                        <div class="col-sm-9 col-xl-9 col-md-8">
                                            <p class=" span_width">₦</p><input type="text"
                                                pattern="[\-\+]?[0-9]*(\.[0-9]+)?" class="form-control input_width"
                                                name="daily_sales" id="daily_sales" value="0" />
                                            <p class="span_width"></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row ">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row flex_row">
                                        <div class="col-sm-3 col-xl-3 col-md-4"> <label>Labor</label></div>
                                        <div class="col-sm-9 col-xl-9 col-md-8">
                                            <p class="span_width"> </p><input type="text" pattern="[0-9]*"
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="row flex_row">
                                        <div class="col-sm-3 col-xl-3 col-md-4"> <label>Food</label></div>
                                        <div class="col-sm-9 col-xl-9 col-md-8">
                                            <p class="span_width"></p><input type="text" pattern="[0-9]*"
                        ...
                        <div class="accordion-body">
                            <div class="row ">
                                <textarea class="form-control" rows="5" name="repair_and_mentenance"
                                    id="repair_and_mentenance"></textarea>
...
$(document).ready(function() {
    ...
    $("#submit_form").submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() . "managerlogbook/store" ?>',
            data: formData,
