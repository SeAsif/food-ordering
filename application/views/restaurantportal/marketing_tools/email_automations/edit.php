    ...
    <form id="submit_form" action="javascript: void(0)">
        ...
        <div class="card card_width mb-4">
            ...
            <div class="card-body p-3">
                <!-- <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" <? echo $campaign->condition=="Birthday"?
                    'checked':'';?> name="condition" id="birthday" value="Birthday">
                    <label class="form-check-label" for="birthday">Birthday</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="condition" <? echo
                        $campaign->condition=="Anniversary"? 'checked':'';?> id="aniversary" value="Anniversary">
                    <label class="form-check-label" for="aniversary"> Anniversary</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="condition" <? echo
                        $campaign->condition=="Registration"? 'checked':'';?> id="registration" value="Registration">
                    <label class="form-check-label" for="registration"> Registration</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="condition" <? echo
                        $campaign->condition=="FirstOrder"? 'checked':'';?> id="f_order" value="FirstOrder">
                    <label class="form-check-label" for="f_order"> First Order</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="condition" <? echo
                        $campaign->condition=="LastOrder"? 'checked':'';?> id="l_order" value="LastOrder">
                    <label class="form-check-label" for="l_order"> Last Order</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="condition" <? echo
                        $campaign->condition=="SpecificDay"? 'checked':'';?> id="s_date" value="SpecificDay">
        ...
        <div class="card card_width mb-4">
            ...
            <div class="card-body p-0">
                <textarea name="editor1"> <? echo $campaign->details; ?></textarea>
            </div>
        </div>
                        ...
                        <select name="coupon_id" class=" form-select" id="">
                            ...
                            if(!empty($coupons)){
                                foreach($coupons as $key=>$value){
                                    if($value->id==$campaign->coupon_id){
                ...
                <div class="grid_roww">
                    <div class="form-group">
                        <label class="font_family w-100" for="coupon">
                            ...
                            <input type="date" class="form-control" name="start_date"
                                value="<? echo $campaign->start_date; ?>">
                        </label>
                    </div>
                    <div class="form-group">
                        <label class="font_family w-100" for="coupon">
                    ...
                    <div class="form-group" style="display: flex;align-items:flex-end;height:100%;">
                        ...
                        <div class="form-check mb-0">
                            <input class="form-check-input" type="checkbox" name="is_never_expire"
                                id="flexCheckDefault">
        ...
        <div class="card card_width mb-4">
            ...
            <div class="card-body p-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" <? echo $campaign->status=="Active"? 'checked':''; ?>
                    name="status" id="inlineRadio1" value="Active">
                    <label class="form-check-label" for="inlineRadio1">Active</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" <? echo $campaign->status=="Inactive"? 'checked':''; ?>
...
$(document).ready(function() {
    ...
    $("#submit_form").submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() . "marketingtools/update_campaign" ?>',
            data: formData,
