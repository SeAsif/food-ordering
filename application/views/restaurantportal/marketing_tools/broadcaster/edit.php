...
<div class=" title_bar content employe_table">
    ...
    <input type="hidden" value="<? echo $broadcaster->id;?>" name="id">
            ...
            <div class="card-body p-3">
                <div class="form-group">
                    <label class="font_family width_changed" for="coupon">
                        ...
                        <input type="text" class="form-control" name="name"  value="<? echo $broadcaster->name;?>" id="name">
                    </label>
                </div>
            </div>
        ...
        <div class="card card_width mb-4">
            ...
            <div class="card-body p-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" <? echo $broadcaster->is_open=="Enable"? 'checked':'';?>  name="is_open" id="is_open" value="Enable">
                    <label class="form-check-label" for="inlineRadio1">Enable</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="is_open"  <? echo $broadcaster->is_open=="Disable"? 'checked':'';?>  id="inlineRadio2" value="Disable">
        ...
        <div class="card card_width mb-4">
            ...
            <div class="card-body p-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio"  <? echo $broadcaster->is_on=="On"? 'checked':'';?>  checked name="is_on" id="on" value="On">
                    <label class="form-check-label" for="on">On</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" <? echo $broadcaster->is_on=="Off"? 'checked':'';?> name="is_on" id="off" value="Off">
        ...
        <div class="card card_width mb-4">
            ...
            <div class="card-body p-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio"  <? echo $broadcaster->duration=="Days"? 'checked':'';?>  name="duration" id="active" value="Days">
                    <label class="form-check-label" for="active">Days(s)</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio"  <? echo $broadcaster->duration=="Range"? 'checked':'';?> name="duration" id="inactive" value="Range">
                    <label class="form-check-label" for="inactive">Date Range</label>
                </div>
                <div class="row">
                    <div class="date-range date_range_inline">
                        <div class="col-lg-6  col-xl-6 col-md-6 col-12">
                            <div class="form-group ">
                                <label class="font_family w-75" for="start-date">
                                    <span class="mb-2" style="font-weight:500;">From:</span>
                                    <input type="date" class="form-control " id="log_date" name="date_range_start"  value="<? echo $broadcaster->start_date;?>">
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-6 col-md-6 col-12" style="margin-left:10px">
                            <div class="form-group ">
                                <label class="font_family w-75" for="coupon">
                                    <span class="mb-2" style="font-weight:500;" name="end_time"  >To</span>
                                    <input type="date" class="form-control "  name="date_range_end" value="<? echo $broadcaster->end_date;?>">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col_mrg_btm">
                        <div class="form-check">
                            ...
                            <input class="form-check-input checkbox_adj" <? echo $broadcaster->all_day==1?'checked':'';?> name="all_day" type="checkbox" />
                    ...
                    <div class="col-lg-6  col-xl-6 col-md-6 col-12">
                        <div class="form-group ">
                            <label class="font_family w-75" for="coupon">
                                <span class="mb-2" style="font-weight:500;">From</span>
                                <input type="time" class="form-control time_range" name="start_time" value=" <? echo $broadcaster->start_time;?>">
                            </label>
                        </div>
                    </div>
                    <div class="col-lg-6 col-xl-6 col-md-6 col-12">
                        <div class="form-group ">
                            <label class="font_family w-75" for="coupon">
                                ...
                                <input type="time" class="form-control time_range" name="end_time" value=" <? echo $broadcaster->end_time;?>">
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="card card_width mb-4">
            ...
            <div class="card-body p-3">
                <textarea name="message" id="message"><? echo $broadcaster->message;?></textarea>
            </div>
...
$("#submit_form").submit(function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: '<?= base_url() . "marketingtools/update_broadcaster" ?>',
        data: formData,
