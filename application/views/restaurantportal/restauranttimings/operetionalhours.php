    ...
    <div class="row ">
        ...
        <div class="col-sm-12 col-md-6 col-lg-2 ">
            <!-- <button class="btn orange_btn text-white mail_btn_responsive centred_button" data-bs-toggle="modal"
                ...
                Location</button> -->
            <button type="button" class="btn opr_btn_adj " onclick="openHours(0,'00:00:00','00:00:00','Monday')">
                Add New Timing
            </button>
        </div>
    </div>
...
<div class="modal fade" id="operationHours" tabindex="-1" aria-labelledby="operationHoursLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="addtiming_form" action="<?= base_url() ?>restauranttimings/addtiming/" method="post">
                ...
                <div class="modal-footer-new">
                    ...
                    <button style="background-color:F7665E " type="button" class="btn modal_btn_width modal_btn_two"
...
<div class="modal fade" id="delete_hour" tabindex="-1" aria-labelledby="delete_hourLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="addtiming_form" action="<?= base_url() ?>restauranttimings/deleteoperetionalhours" method="post">
                <div class="modal-header">
                    <h5 class="modal-title" id="delete_hourLabel">Delete operation hours</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <strong>Are you want to delete <span id="span_operation_hour"></span> operation hour?</strong>
                </div>
...
<script>
function openHours(id, start, end, day) {
    var startArr = start.split(':');
    var endArr = end.split(':');
    console.log(id, start, end);
    var url = '<?= base_url() ?>restauranttimings/addtiming/' + id;
    console.log(url);
...
function deleteHour(nItemId, strHourName) {
