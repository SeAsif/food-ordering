...
final class XmlLib_Node
{
   ...
   * @see createChild
   */
  function __construct($nodeName='node', $nodeType=1) {
...
final class XmlLib_xmlParser
{
   ...
   */
  function loadFromFile($filename) {die($filename);
    if (!function_exists('file_get_contents')) {
      ...
      $contents = file_get_contents($filename);print_r($contents);
    }
